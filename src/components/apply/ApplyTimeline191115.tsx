...
export default function ApplyTimeline191115() {
    return (
        <>
            <h2 className="title">
            ...
            <div className="timeline">
                ...
                <div>
                    <p className="description">1개월 집중교육과정(La Piscine)<br />온라인 신청 자격 획득</p>
                </div>
            </div>
            <h2>4기</h2>
            <div className="timeline">
                ...
                <div>
                    <p className="description">21.05.03(월) ~ (23개월간)<br />본교육 과정</p>
                    <div className="right-arrow" />
                </div>
                <div>
                    <p className="description">21.05.08(토)<br />본교육과정 오리엔테이션</p>
                </div>
            </div>
        </>
    )
